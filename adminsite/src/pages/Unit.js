                        ...
                        <div class="col-lg">
                            <div class="card">
                                <div class="card-header">
                                    <strong class="card-title">View Units</strong>
                                </div>
                                <div class="card-body">
                        ...
                        <div class="col-lg-5">
                            <div class="card">
                                ...
                                <div class="card-body card-block">
                                    <div class="form-group"><label for="company" class=" form-control-label">Unit Name</label><input type="text" id="company" placeholder="Enter category name" class="form-control" /></div>
                                    <button type="button" class="btn btn-primary btn-block">Add</button>

                                </div>
                            </div>
                            <div class="card">
                                <div class="card-header"><strong>Edit Units</strong></div>
                                <div class="card-body card-block">
                                    <div class="form-group"><label for="company" class=" form-control-label">Unit Name</label><input type="text" id="company" placeholder="Enter category name" class="form-control" /></div>
