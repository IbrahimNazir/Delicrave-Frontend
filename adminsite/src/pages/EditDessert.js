...
function EditProduct() {
    ...
    const defaultDessert = { category: {}, id: "", flavor: {}, image:{} }
    ...
    function dessertOnSubmit(event) {
        ...
        const putDessertAsync = async (event, dessertId, name, price, stockquantity, unit, description, category, flavor, image, editBtn) => {
            try {
                const result = await apiEditDessert(dessertId, name, price, stockquantity, unit, description, category, flavor, image);
                                ...
                                <div class="card-body card-block">
                                    ...
                                    <div class="form-group"><label for="image" class=" form-control-label">Image</label>
                                        <div class="custom-file">
                                            <input onChange={(event) => handleInput(event)} type="file" class="custom-file-input" id="image" name='image' />
